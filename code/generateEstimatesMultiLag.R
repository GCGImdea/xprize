...
path_symptom_lags_out <- "../data/estimates-symptom-lags/estimates/"
...
for (file in files){
  ...
  fileoutname<-paste0(path_symptom_lags_out,iso_code_country,"-estimates.csv")
  fileoutnameforesync<-paste0(path_symptom_lags_out,iso_code_country,"-foresync.csv")
