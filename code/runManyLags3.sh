...
#GT GU GY HK HN HR HT HU ID IE IL IN IQ IR IS IT JM JO JP KE KG KH KM KR KW KZ LA LB LK LR LS LT LU LV LY MA MC MD MG ML MM MN MO MR MU MW MX MY MZ NA NE NG NI NL NO NP NZ OM PA PE PG PH PK"
ALLCOUNTRIES="PL PR PS PT PY QA RO RS RU RW SA SB SC SD SE SG SI SK SL SM SN SO SR SS SV SY SZ TD TG TH TJ TL TN TR TT TW TZ UA UG US UY UZ VE VN VU XK YE ZA ZM ZW"
#COUNTRIESTODO='"PT"'
