...
ALLCOUNTRIES="PL PR PS PY QA RO RS RU RW SA SB SC SD SE SG SI SK SL SM SN SO SR SS SV SY SZ TD TG TH TJ TL TN TR TT TW TZ UA UG US UY UZ VE VN VU XK YE ZA ZM ZW"
#COUNTRIESTODO='"PT"'
